...
public class UserManager {
    ...
    public static User addUser(User user){
        ...
        try{
            ...
            String requete = "INSERT INTO users(name,firstname,email,password) VALUE (?,?,?,?)";
    ...
    public User findUser(User user){
        ...
        try {
            ...
            String requete = "SELECT id,name,firstname,email,password FROM users WHERE email=?";
            ...
            while(rs.next()){
                if(rs.getString(1)!=null){
                    ...
                    verif.setNom(rs.getString("name"));
                    verif.setPrenom(rs.getString("firstname"));
    ...
    public static User updateUser(User user){
        ...
        try{
            Statement stm = connexion.createStatement();
            String requete = "UPDATE users SET name = ?, firstname = ? WHERE id = (SELECT id FROM users WHERE email = ?)";
    ...
    public ArrayList<User> getAllUsers(){
        ...
        try{
            Statement stm = connexion.createStatement();
            String requete = "SELECT id,name,firstname,email,password FROM users";
            ...
            while (rs.next()){
                ...
                newUser.setPrenom(rs.getString("firstname"));
                newUser.setNom(rs.getString("name"));
